              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                     const Text("208.5",style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color:  Color.fromARGB(255, 234, 86, 160)),),
                     const Text("lbs",style: TextStyle(color:  Color.fromARGB(255, 234, 86, 160),fontSize: 30),)
                    ],
                  ),
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            const Text("Today 7:26 AM",style: TextStyle(color: Colors.black87),)
                          ],
                        ),
                        const Text("In body smart scale",style: TextStyle(color:Color.fromARGB(255, 234, 86, 160),fontSize: 17,fontWeight: FontWeight.w500),)
                      ],
                    ),
             ),
             Positioned(
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text("177 cm",style: TextStyle(color: Colors.black,fontSize: 18,fontWeight: FontWeight.w500),),
