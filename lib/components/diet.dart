              ...
              children: [
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        height: 40,
                        width: 2,
                         color: const Color.fromARGB(255, 234, 86, 160),
                      ),
                    ),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                            ...
                            const Padding(
                              ...
                              CircleAvatar(
                                ...
                                child: SizedBox(
                                  height: 30,
                                  width: 30,
                                  child: Image(image: AssetImage("assets/images/eaten-removebg-preview.png",),fit: BoxFit.fill,)),
                              ),
                           ),
                           const SizedBox(width: 2,),
                            
                            const Text("1306",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
                            const SizedBox(width: 2,),
                              ...
                              const Padding(
                                ...
                                CircleAvatar(
                                  ...
                                  child: SizedBox(
                                    height: 30,
                                    width: 30,
                                    child: Image(image:AssetImage("assets/images/burned-removebg-preview.png",),fit: BoxFit.fill, )),
                                ),
                             ),
                             const SizedBox(width: 2,),
                ...
                Positioned(
                        ...
                        child: Row(
                          ...
                          children: [
                            Column(
                              ...
                              const Text("14g Left",style: TextStyle(color: Colors.grey),)
                              ],
                            ),
                            Column(
                              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  ...
                  const Positioned(
                    ...
                    child: Text("1209",style: TextStyle(fontSize: 25,color:   Color.fromARGB(255, 234, 86, 160),),)),
                  const Positioned(
                    top: 87,
                    right: 58,
